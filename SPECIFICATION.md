...
**Creators Garden（クリエイターズガーデン）**は、クリエイター同士がコラボレーションや作品紹介を行うためのプラットフォームです。小説家、イラストレーター、音楽家、ゲームクリエイターなど、様々なジャンルのクリエイターが集まり、作品を共に生み出す場を提供します。
...
- 投稿の「挙げ」機能（24時間に1回）
- フィードバックシステム
- プラン管理（Seed Plan、Grow Plan、Bloom Plan）
...
- **機能**:
  ...
  - プランによる制限（Seed Plan: 10件まで、Grow Plan以上: 無制限）
